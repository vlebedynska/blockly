...
Blockly.Blocks['procedures_defnoreturn'] = {
     ...
     * 
     * @param {boolean}
     *            hasStatements True if a statement block is needed.
     * @this Blockly.Block
     */
     ...
     * 
     * @param {=boolean}
     *            opt_paramIds If true include the IDs of the parameter quarks.
     *            Used by Blockly.Procedures.mutateCallers for reconnection.
...
Blockly.Blocks['procedures_ifreturn'] = {
    ...
    /**
     * List of block types that are functions and thus do not need warnings. To
     * add a new function type add this to your code:
...
Blockly.Blocks['robProcedures_defnoreturn'] = {
    ...
    init : function() {
        ...
        nameField.setSpellcheck(false);
        this.appendDummyInput().appendField(nameField, 'NAME').appendField('', 'WITH');
        this.appendStatementInput('STACK').appendField(Blockly.Msg.PROCEDURES_DEFNORETURN_DO);
     ...
     * 
     * @return {!Array} Tuple containing three elements: - the name of the
     *         defined procedure, - that it DOES NOT have a return value.
     * @this Blockly.Block
     */
    getProcedureDef : function() {
...
Blockly.Blocks['robProcedures_defreturn'] = {
    ...
    init : function() {
        ...
        this.setTooltip(Blockly.Msg.PROCEDURES_DEFRETURN_TOOLTIP);
        this.appendValueInput('RETURN').setAlign(Blockly.ALIGN_RIGHT).appendField(Blockly.Msg.RETURN).appendField(returnDropdown, 'TYPE').appendField(Blockly.Msg.PROCEDURES_DEFRETURN_BACK).setCheck('Number');
        this.declare_ = false;
    ...
    addDeclarationStatement_ : function() {
        ...
        this.getInput('ST').connection.setCheck('declaration_only');
        this.appendStatementInput('STACK').appendField(Blockly.Msg.PROCEDURES_DEFNORETURN_DO);
        this.appendValueInput('RETURN').setAlign(Blockly.ALIGN_RIGHT).appendField(Blockly.Msg.RETURN).appendField(returnDropdown, 'TYPE').appendField(Blockly.Msg.PROCEDURES_DEFRETURN_BACK).setCheck(this.returnType_);
...
Blockly.Blocks['robProcedures_callnoreturn'] = {
     ...
     *            <string>} paramNames New param names, e.g. ['x', 'y', 'z'].
     * @param {!Array.
     *            <string>} paramTypes Types of the params
     * @this Blockly.Block
     */
     ...
     * @param {Number}
     *            action 0 parameter has changed the type 1 new parameter -1
     *            delete parameter
     * @this Blockly.Block
     */
