...
Blockly.Blocks['mbedActions_motor_on'] = {
	...
	init : function() {
		...
		this.appendValueInput('POWER').appendField(Blockly.Msg.MOTOR)
				...
				.appendField(Blockly.Msg.ON).appendField(
...
Blockly.Blocks['mbedActions_motors_on'] = {
	...
	init : function() {
		var motorFirst = new Blockly.FieldDropdown([ [ 'Port A', 'A' ],
				[ Blockly.Msg.CB_LEFT, 'LEFT' ] ]);
		var motorSecond = new Blockly.FieldDropdown([ [ 'Port B', 'B' ],
				[ Blockly.Msg.CB_RIGHT, 'RIGHT' ] ]);
		this.setColour(Blockly.CAT_ACTION_RGB);
		this.appendValueInput('POWER_A').appendField(Blockly.Msg.MOTOR)
				.appendField(motorFirst, 'A').appendField(Blockly.Msg.ON)
				.appendField(Blockly.Msg.MOTOR_SPEED).setCheck('Number');
		this.appendValueInput('POWER_B').setAlign(Blockly.ALIGN_RIGHT)
				.appendField(motorSecond, 'B').appendField(Blockly.Msg.ON)
				.appendField(Blockly.Msg.MOTOR_SPEED).setCheck('Number');
		this.setPreviousStatement(true);
		this.setNextStatement(true);
...
Blockly.Blocks['mbedActions_single_motor_on'] = {
	...
	init : function() {
		this.setColour(Blockly.CAT_ACTION_RGB);
		this.appendValueInput('POWER').appendField(Blockly.Msg.MOTOR)
				.appendField(Blockly.Msg.MOTOR_ON).appendField(Blockly.Msg.ON)
				.appendField(Blockly.Msg.MOTOR_SPEED).setCheck('Number');
		this.setPreviousStatement(true);
		this.setNextStatement(true);
		this.setTooltip(Blockly.Msg['SINGLE_MOTOR_ON_TOOLTIP_'
				+ this.workspace.device.toUpperCase()]
				|| Blockly.Msg.SINGLE_MOTOR_ON_TOOLTIP);
	}
};
...
Blockly.Blocks['mbedActions_single_motor_stop'] = {
	...
	init : function() {
		...
		this.appendDummyInput().appendField(Blockly.Msg.MOTOR).appendField(
				Blockly.Msg.MOTOR_STOP).appendField(mode, 'MODE');
		this.setPreviousStatement(true);
		this.setNextStatement(true);
...
Blockly.Blocks['mbedActions_motors_stop'] = {
	...
	init : function() {
		this.setColour(Blockly.CAT_ACTION_RGB);
		this.appendDummyInput().appendField(Blockly.Msg.MOTOR_STOP)
				.appendField(Blockly.Msg.MOTOR_PORT + " A + B");
		this.setPreviousStatement(true);
		this.setNextStatement(true);
...
Blockly.Blocks['mbedActions_display_text'] = {
	...
	init : function() {
		this.setColour(Blockly.CAT_ACTION_RGB);
		var what = new Blockly.FieldDropdown([
				[ Blockly.Msg.DISPLAY_TEXT, 'TEXT' ],
				[ Blockly.Msg.DISPLAY_CHARACTER, 'CHARACTER' ] ]);
		this.appendValueInput('OUT').appendField(Blockly.Msg.DISPLAY_SHOW)
				.appendField(what, 'TYPE').setCheck(
...
Blockly.Blocks['mbedActions_display_image'] = {
	...
	init : function() {
		...
		var what = new Blockly.FieldDropdown([
				...
				[ Blockly.Msg.DISPLAY_ANIMATION, 'ANIMATION' ] ], function(
				option) {
			if (option) {
				this.sourceBlock_.updateShape_(option);
			}
		});
		this.appendValueInput('VALUE').appendField(Blockly.Msg.DISPLAY_SHOW)
				.appendField(what, 'TYPE').setCheck('Image');
		this.setPreviousStatement(true);
		this.setNextStatement(true);
...
Blockly.Blocks['mbedActions_display_getPixel'] = {
	init : function() {
		...
		this.appendValueInput('X').setCheck('Number').appendField(
				Blockly.Msg.GET + ' ' + Blockly.Msg.DISPLAY_PIXEL_TITLE)
				.appendField(Blockly.Msg.DISPLAY_PIXEL_BRIGHTNESS).setAlign(
...
Blockly.Blocks['mbedActions_display_setPixel'] = {
	init : function() {
		this.setColour(Blockly.CAT_ACTION_RGB);
		this.appendValueInput('X').setCheck('Number').appendField(
				Blockly.Msg.SET + ' ' + Blockly.Msg.DISPLAY_PIXEL_TITLE)
				.setAlign(Blockly.ALIGN_RIGHT).appendField(Blockly.Msg.X);
		this.appendValueInput('Y').setCheck('Number').setAlign(
				Blockly.ALIGN_RIGHT).appendField(Blockly.Msg.Y);
		this.appendValueInput('BRIGHTNESS').setCheck('Number').setAlign(
...
Blockly.Blocks['mbedActions_ledBar_set'] = {
	init : function() {
		this.setColour(Blockly.CAT_ACTION_RGB);
		this.appendValueInput('X').setCheck('Number').appendField(
				Blockly.Msg.SET + ' ' + Blockly.Msg.LEDBAR).setAlign(
				Blockly.ALIGN_RIGHT).appendField(Blockly.Msg.X);
		this.appendValueInput('BRIGHTNESS').setCheck('Number').setAlign(
				Blockly.ALIGN_RIGHT).appendField(
				Blockly.Msg.DISPLAY_PIXEL_BRIGHTNESS);
...
Blockly.Blocks['mbedActions_display_getBrightness'] = {
	init : function() {
		...
		this.appendDummyInput().setAlign(Blockly.ALIGN_RIGHT).appendField(
				Blockly.Msg.GET + ' ' + Blockly.Msg.DISPLAY_PIXEL_BRIGHTNESS);
...
Blockly.Blocks['mbedActions_display_setBrightness'] = {
	init : function() {
		...
		this.appendValueInput('BRIGHTNESS').setCheck('Number').setAlign(
				Blockly.ALIGN_RIGHT).appendField(
				Blockly.Msg.SET + ' ' + Blockly.Msg.DISPLAY_PIXEL_BRIGHTNESS);
		this.setPreviousStatement(true);
		this.setNextStatement(true);
...
Blockly.Blocks['mbedActions_fourDigitDisplay_show'] = {
	init : function() {
		...
		this.appendValueInput('VALUE').appendField(
				Blockly.Msg.DISPLAY_SHOW + " " + Blockly.Msg.FOURDIGITDISPLAY)
				.appendField(Blockly.Msg.VARIABLES_TYPE_NUMBER).setCheck(
						'Number');
		this.appendValueInput('POSITION').setAlign(Blockly.ALIGN_RIGHT)
				.appendField(Blockly.Msg.FROM_POSITION).setCheck('Number');
		this.appendValueInput('COLON').setAlign(Blockly.ALIGN_RIGHT)
				.appendField(Blockly.Msg.COLON).setCheck('Boolean');
		this.setPreviousStatement(true);
		this.setNextStatement(true);
...
Blockly.Blocks['mbedActions_fourDigitDisplay_clear'] = {
	init : function() {
		this.setColour(Blockly.CAT_ACTION_RGB);
		this.appendDummyInput().appendField(Blockly.Msg.DISPLAY_CLEAR)
				.appendField(Blockly.Msg.FOURDIGITDISPLAY);
		this.setPreviousStatement(true);
		this.setNextStatement(true);
...
Blockly.Blocks['mbedActions_play_note'] = {
	...
	init : function() {
		...
		var duration = new Blockly.FieldDropdown([
				[ Blockly.Msg.PLAY_WHOLE, '2000' ],
				[ Blockly.Msg.PLAY_HALF, '1000' ],
				[ Blockly.Msg.PLAY_QUARTER, '500' ],
				[ Blockly.Msg.PLAY_EIGHTH, '250' ],
		...
		if (this.workspace.device === 'wedo') {
			...
			this.appendDummyInput().appendField(Blockly.Msg.PLAY).appendField(
					ports, 'ACTORPORT').appendField(duration, 'DURATION')
					.appendField(frequence, 'FREQUENCE');
		} else {
			this.appendDummyInput().appendField(Blockly.Msg.PLAY).appendField(
					duration, 'DURATION').appendField(frequence, 'FREQUENCE');
		}
		this.setPreviousStatement(true);
		this.setNextStatement(true);
...
Blockly.Blocks['mbedActions_play_setVolume'] = {
	...
	init : function() {
		...
		this.appendValueInput('VOLUME').appendField(
				Blockly.Msg.SET + ' ' + Blockly.Msg.PLAY_VOLUME).setCheck(
				'Number');
		this.setPreviousStatement(true);
		this.setNextStatement(true);
...
Blockly.Blocks['mbedActions_write_to_pin'] = {
	...
	init : function() {
		...
		var valueType = new Blockly.FieldDropdown(
				...
				function(option) {
					if (option
							&& this.sourceBlock_.getFieldValue('VALUETYPE') !== option) {
						this.sourceBlock_.updatePins_(option);
					}
				});
		this.appendValueInput('VALUE').appendField(Blockly.Msg.PIN_WRITE)
				.appendField(valueType, 'VALUETYPE').appendField(
						Blockly.Msg.VALUE_TO + ' ' + Blockly.Msg.SENSOR_PIN)
				.appendField(new Blockly.FieldDropdown([ [ "dummy", '0' ] ]),
						'PIN').setCheck('Number');
...
Blockly.Blocks['mbedActions_pin_set_pull'] = {
	...
	init : function() {
		...
		var pins = new Blockly.FieldDropdown([ [ 'P0', '0' ], [ 'P1', '1' ],
				[ 'P2', '2' ], [ 'P3', '3' ], [ 'A0', '4' ], [ 'A1', '5' ],
				[ 'C04', 'C04' ], [ 'C05', 'C05' ], [ 'C06', 'C06' ],
				[ 'C07', 'C07' ], [ 'C08', 'C08' ], [ 'C09', 'C09' ],
				[ 'C10', 'C10' ], [ 'C11', 'C11' ], [ 'C12', 'C12' ],
				...
				[ 'C19', 'C19' ] ]);
		this.appendDummyInput().appendField(
				Blockly.Msg.SET + ' ' + Blockly.Msg.PIN_PULL).appendField(pull,
				'PIN_PULL').appendField(
...
Blockly.Blocks['mbedActions_switch_led_matrix'] = {
	...
	init : function() {
		this.setColour(Blockly.CAT_ACTION_RGB);
		var state = new Blockly.FieldDropdown([ [ Blockly.Msg.ON, 'ON' ],
				[ Blockly.Msg.OFF, 'OFF' ] ]);
		this.appendDummyInput().appendField(
				Blockly.Msg.SWITCH + ' ' + Blockly.Msg.LED_MATRIX).appendField(
				state, 'STATE');
		this.setPreviousStatement(true);
		this.setNextStatement(true);
