...
Blockly.Blocks['bob3Sensors_touch_getSample'] = {
    ...
    init : function() {
        ...
        var pair = new Blockly.FieldDropdown([ [ Blockly.Msg.SENSOR_TOP, '1' ], [ Blockly.Msg.CENTER, '2' ], [ Blockly.Msg.SENSOR_BOTTOM, '3' ],
                [ Blockly.Msg.SENSOR_ANY, '4' ] ]);
        this.appendDummyInput().appendField(Blockly.Msg.SENSOR_IS_ARM).appendField(arm, 'ARM').appendField(pair, 'PAIR').appendField(Blockly.Msg.SENSOR_IS_TOUCHED);
