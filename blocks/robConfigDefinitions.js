...
var pinsDigital = {};
pinsDigital.uno = function() {
    return createPins(0, 13);
};
pinsDigital.nano = function() {
    return createPins(0, 13, "D");
};
pinsDigital.mega = function() {
    return createPins(0, 53);
};

var pinsAnalog = {};
pinsAnalog.uno = function() {
    return createPins(0, 5, "A", "A");
};
pinsAnalog.nano = function() {
    return createPins(0, 7, "A", "A");
};
pinsAnalog.mega = function() {
    return createPins(0, 15, "A", "A");
};

var pins_wedo = function() {
