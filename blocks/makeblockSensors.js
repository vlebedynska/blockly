 ...
 Blockly.Blocks['makeblockSensors_getSample_makeblock'] = {
       ...
       init : function() {
           ...
           sensorType = new Blockly.FieldDropdown([ [ Blockly.Msg.SENSOR_TOUCH, 'TOUCH' ],
                   ...
                   [ Blockly.Msg.SENSOR_LIGHT, 'SENSOR_LIGHT' ],
                   [ Blockly.Msg.SENSOR_AMBIENTLIGHT, 'SENSOR_AMBIENTLIGHT' ],
                   [ Blockly.Msg.SENSOR_GYRO, 'GYRO_ANGLE' ],
                   [ Blockly.Msg.NAO_ACCELEROMETER, 'ACCELEROMETER' ], [ Blockly.Msg.SENSOR_TIMER, 'TIME' ],
                   [Blockly.Msg.SENSOR_JOYSTICK, 'SENSOR_JOYSTICK' ], [ Blockly.Msg.SENSOR_FLAME, 'SENSOR_FLAME' ],
                   [Blockly.Msg.SENSOR_PIRMOTION, 'SENSOR_PIRMOTION' ], [ Blockly.Msg.SENSOR_TEMPERATURE, 'SENSOR_TEMPERATURE' ],
                   [ Blockly.Msg.SENSOR_BATTERY, 'SENSOR_BATTERY' ] ], function(option) {
