...
Blockly.Blocks['math_number'] = {
    ...
    mutationToDom : function() {
        ...
        container.setAttribute('name', parentType);
        return container;
    },
        ...
        this.jsonInit({
            ...
            "args0" : [
                    ...
                    },
                    {
                        "type" : "field_dropdown",
                        "name" : "OP",
                        "options" : [ [ Blockly.Msg.MATH_ADDITION_SYMBOL, 'ADD' ], [ Blockly.Msg.MATH_SUBTRACTION_SYMBOL, 'MINUS' ],
            ...
            "args0" : [
                    {
                        "type" : "field_dropdown",
                        "name" : "OP",
                        "options" : [ [ Blockly.Msg.MATH_SINGLE_OP_ROOT, 'ROOT' ], [ Blockly.Msg.MATH_SINGLE_OP_ABSOLUTE, 'ABS' ], [ '-', 'NEG' ],
                                [ 'ln', 'LN' ], [ 'log10', 'LOG10' ], [ 'e^', 'EXP' ], [ '10^', 'POW10' ] ]
                    }, {
                        "type" : "input_value",
                        "name" : "NUM",
                        "check" : "Number"
            ...
            "args0" : [
                    {
                        "type" : "field_dropdown",
                        "name" : "OP",
                        "options" : [ [ Blockly.Msg.MATH_TRIG_SIN, 'SIN' ], [ Blockly.Msg.MATH_TRIG_COS, 'COS' ], [ Blockly.Msg.MATH_TRIG_TAN, 'TAN' ],
            ...
            "args0" : [
                    {
                        "type" : "field_dropdown",
                        "name" : "OP",
                        "options" : [ [ Blockly.Msg.MATH_ROUND_OPERATOR_ROUND, 'ROUND' ], [ Blockly.Msg.MATH_ROUND_OPERATOR_ROUNDUP, 'ROUNDUP' ],
...
Blockly.Blocks['math_on_list'] = {
     ...
     * 
     * @param {string}
     *            newOp Either 'MODE' or some op than returns a number.
     * @private
     * @this Blockly.Block
     */
